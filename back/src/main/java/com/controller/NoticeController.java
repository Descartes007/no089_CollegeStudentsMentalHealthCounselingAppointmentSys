...
public class NoticeController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        //字典表数据转换
        List<NoticeView> list =(List<NoticeView>)page.getList();
        for(NoticeView c:list){
            //修改对应字典表字段
    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(notice !=null){
            ...
            BeanUtils.copyProperties( notice , view );//把实体数据重构到view中
    ...
    */
    ...
    public R save(@RequestBody NoticeEntity notice, HttpServletRequest request){
        logger.debug("save方法:,,Controller:{},,notice:{}",this.getClass().getName(),notice.toString());
        ...
        Wrapper<NoticeEntity> queryWrapper = new EntityWrapper<NoticeEntity>()
            .eq("notice_name", notice.getNoticeName())
    ...
    */
    ...
    public R update(@RequestBody NoticeEntity notice, HttpServletRequest request){
        logger.debug("update方法:,,Controller:{},,notice:{}",this.getClass().getName(),notice.toString());
...
//            return R.error(511,"永远不会进入");
        ...
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        NoticeEntity noticeEntity = noticeService.selectOne(queryWrapper);
        if("".equals(notice.getNoticePhoto()) || "null".equals(notice.getNoticePhoto())){
                notice.setNoticePhoto(null);
        }
        if(noticeEntity==null){
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<NoticeEntity> noticeList = new ArrayList<>();//上传的东西
...
//                            noticeEntity.setNoticeName(data.get(0));                    //通知名称 要改的
//                            noticeEntity.setNoticePhoto("");//详情和图片
//                            noticeEntity.setNoticeTypes(Integer.valueOf(data.get(0)));   //通知类型 要改的
//                            noticeEntity.setInsertTime(date);//时间
//                            noticeEntity.setNoticeContent("");//详情和图片
//                            noticeEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody NoticeEntity notice, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,notice:{}",this.getClass().getName(),notice.toString());
        Wrapper<NoticeEntity> queryWrapper = new EntityWrapper<NoticeEntity>()
            .eq("notice_name", notice.getNoticeName())
            .eq("notice_types", notice.getNoticeTypes())
            ;
